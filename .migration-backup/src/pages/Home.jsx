...
import { ShoppingCart, Heart, ChevronLeft, ChevronRight, Phone, Wrench, AlertCircle, Info } from "lucide-react";
...
function HeroSection() {
  ...
  return (
    <section className="relative w-full bg-background">
      {/* Decorative Orbs */}
      <div className="absolute -top-32 -right-32 w-96 h-96 bg-primary/20 rounded-full blur-[100px] pointer-events-none z-0" style={{ animation: 'floatA 10s ease-in-out infinite' }} />
      <div className="absolute -bottom-32 -left-32 w-[500px] h-[500px] bg-accent/10 rounded-full blur-[120px] pointer-events-none z-0" style={{ animation: 'floatB 12s ease-in-out infinite alternate' }} />
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: "easeOut" }} className="relative z-10 max-w-[1920px] mx-auto">
        <div className="relative w-full h-[30vh] sm:h-[45vh] md:h-[58vh] min-h-[200px] max-h-[700px] overflow-hidden group">
          ...
          <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex gap-3 z-20">
            {heroImages.map((_, i) => (
              <button key={i} onClick={() => setCurrent(i)} className={`h-2.5 rounded-full transition-all duration-300 ${i === current ? "bg-primary w-8" : "bg-card/50 hover:bg-card w-2.5"}`} aria-label={`Slide ${i+1}`} />
            ))}
          </div>
...
function QuickAccessSection() {
  const actions = [
    { title: "للطلب سجل رقمك", desc: "أدخل رقمك وسنتواصل معك فوراً", icon: "https://media.base44.com/images/public/69f0f838e7b863b3ce41773c/3f432ed21_www_naqi_sa_contact_5300676_e9a33f95.png", color: "group-hover:bg-blue-50" },
    { title: "اطلب صيانة دورية", desc: "احجز موعد الصيانة بكل سهولة", icon: "https://media.base44.com/images/public/69f0f838e7b863b3ce41773c/092d28992_www_naqi_sa_man_10214947_be5547ce.png", color: "group-hover:bg-green-50" },
    { title: "شكوى أو صيانة طارئة", desc: "فريقنا جاهز لحل مشكلتك بسرعة", icon: "https://media.base44.com/images/public/69f0f838e7b863b3ce41773c/3c6f78ebf_www_naqi_sa_gear_11695860_9f5106f6.png", color: "group-hover:bg-red-50" },
  ];
...
// Unified Product Card Component for consistent styling and animations across all sections
      ...
      <div className="bg-card border border-border/60 rounded-2xl overflow-hidden hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:-translate-y-2 transition-all duration-500 group flex flex-col h-full relative z-10">
        ...
        <div className="absolute top-3 left-3 right-3 flex justify-between items-start z-20 pointer-events-none">
          ...
          <button 
            ...
            className="pointer-events-auto bg-card/90 backdrop-blur-md p-2 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-300 hover:bg-primary hover:text-primary-foreground shadow-sm translate-x-2 group-hover:translate-x-0"
          >
...
function PromotionsSection() {
  ...
  return (
    <section className="py-10 sm:py-16 bg-muted/40 relative overflow-hidden" dir="rtl">
    {/* Background Decor */}
    <div className="absolute top-0 right-0 w-1/3 h-full bg-gradient-to-l from-primary/5 to-transparent pointer-events-none" />

    <div className="max-w-7xl mx-auto px-3 sm:px-4 relative z-10">
      <SectionHeader title="أقوى العروض" subtitle="خصومات حصرية لفترة محدودة" />
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
          {allPromos.map((product, i) => (
            <ProductCard key={i} product={product} index={i} />
          ))}
        </div>
        <div className="mt-5 text-center sm:hidden">
          <Button variant="outline" className="w-full font-bold border-primary text-primary hover:bg-primary hover:text-primary-foreground">
            عرض كل العروض
          </Button>
        </div>
      </div>
...
function DesalinationSection() {
  ...
  return (
    <section className="py-10 sm:py-16 bg-background" dir="rtl">
      <div className="max-w-7xl mx-auto px-3 sm:px-4">
        <SectionHeader title="أجهزة التحلية والبرادات" />
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
          {items.map((product, i) => (
            <ProductCard key={i} product={product} index={i} />
          ))}
...
function AirPurifiersSection() {
  ...
  return (
    <section className="py-10 sm:py-16 bg-muted/30" dir="rtl">
      <div className="max-w-7xl mx-auto px-3 sm:px-4">
        <SectionHeader title="منقيات الهواء واجهزة تلطيف الأجواء" />
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
          {items.map((product, i) => (
            <ProductCard key={i} product={product} index={i} />
          ))}
...
function IceMakersSection() {
  ...
  return (
    <section className="py-10 sm:py-16 bg-background" dir="rtl">
      <div className="max-w-7xl mx-auto px-3 sm:px-4">
        <SectionHeader title="صانعات الثلج والآيس كريم" />
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
          {items.map((product, i) => (
            <ProductCard key={i} product={product} index={i} />
          ))}
...
function CoffeeSection() {
  ...
  return (
    <section className="py-10 sm:py-16 bg-muted/30" dir="rtl">
      <div className="max-w-7xl mx-auto px-3 sm:px-4">
        <SectionHeader title="اجهزة تحضير القهوة والمشروبات الساخنة" />
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
          {items.map((product, i) => (
            <ProductCard key={i} product={product} index={i} />
          ))}
...
function HeatersSection() {
  ...
  return (
    <section className="py-10 sm:py-16 bg-background" dir="rtl">
      <div className="max-w-7xl mx-auto px-3 sm:px-4">
        <SectionHeader title="الدفايات والثلاجات" />
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
          {items.map((product, i) => (
            <ProductCard key={i} product={product} index={i} />
          ))}
...
function KitchenSection() {
  const items = [
    { name_ar: "غلاية نقي ريترو R-1", price: 299, image_url: "https://media.base44.com/images/public/69f0f838e7b863b3ce41773c/fa55796ef_www_naqi_sa_compressed---1-1-1_31721383.webp" },
    { name_ar: "فرن نقي E-1", price: 499, original_price: 999, discount: 500, image_url: "https://media.base44.com/images/public/69f0f838e7b863b3ce41773c/519aa4d34_www_naqi_sa_compressed--_619f33b7.webp" },
    { name_ar: "خلاط نقي ديجيتال", price: 599, original_price: 999, discount: 400, image_url: "https://media.base44.com/images/public/69f0f838e7b863b3ce41773c/813878fbf_www_naqi_sa_compressed---43_ae1e9e90.webp" },
    { name_ar: "قلاية هوائية P-1", price: 799, image_url: "https://media.base44.com/images/public/69f0f838e7b863b3ce41773c/26c0f0562_www_naqi_sa_compressed---39_4de6067f.webp" },
  ];
  return (
    <section className="py-10 sm:py-16 bg-muted/30" dir="rtl">
      <div className="max-w-7xl mx-auto px-3 sm:px-4">
        <SectionHeader title="اجهزة المطبخ" />
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
          {items.map((product, i) => (
            <ProductCard key={i} product={product} index={i} />
          ))}
...
function HomeProductsSection() {
  const items = [
    { name_ar: "قارورة عازلة 800 مل (حار – بارد)", price: 99, original_price: 119, discount: 20, image_url: "https://media.base44.com/images/public/69f0f838e7b863b3ce41773c/62070899b_www_naqi_sa_compressed---1-2-scaled_52833cf4.webp" },
    { name_ar: "قارورة عازلة 750 مل (حار – بارد)", price: 99, original_price: 119, discount: 20, image_url: "https://media.base44.com/images/public/69f0f838e7b863b3ce41773c/9158356c1_www_naqi_sa_compressed---1-1-scaled_fa271e88.webp" },
    { name_ar: "كوب نقي 600 مل (حار – بارد)", price: 99, original_price: 119, discount: 20, image_url: "https://media.base44.com/images/public/69f0f838e7b863b3ce41773c/bd083ba7c_www_naqi_sa_compressed---1-scaled_0254c16b.webp" },
    { name_ar: "فلتر شاور نقي – سهل التركيب", price: 149, image_url: "https://media.base44.com/images/public/69f0f838e7b863b3ce41773c/f2e33ae05_www_naqi_sa_compressed-50-_b8bfc2d8.webp" },
  ];
  return (
    <section className="py-10 sm:py-16 bg-background" dir="rtl">
      <div className="max-w-7xl mx-auto px-3 sm:px-4">
        <SectionHeader title="منتجات منزلية" />
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
          {items.map((product, i) => (
            <ProductCard key={i} product={product} index={i} />
          ))}
...
function PumpsSection() {
  ...
  return (
    <section className="py-10 sm:py-16 bg-muted/30" dir="rtl">
      <div className="max-w-7xl mx-auto px-3 sm:px-4">
        <SectionHeader title="المضخات والغطاسات" />
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
          {items.map((product, i) => (
            <ProductCard key={i} product={product} index={i} />
          ))}
...
export default function Home() {
  ...
  useEffect(() => {
    Promise.all([
      ...
      base44.entities.Category.list("order", 20),
    ]).then(([p, c]) => {
      setProducts(p);
      setCategories(c);
