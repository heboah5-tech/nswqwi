              ...
              {items.map((item) => {
                ...
                return (
                  <div key={key} className="flex gap-3 bg-muted/40 rounded-xl p-3">
                    <img src={item.image_url} alt={item.name_ar} className="w-16 h-16 object-contain rounded-lg bg-card shrink-0" />
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        <button onClick={() => updateQty(key!, item.qty - 1)} className="w-7 h-7 rounded-full bg-card border border-border flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-colors">
                        ...
                        <button onClick={() => removeFromCart(key!)} className="mr-auto text-destructive hover:text-destructive/80 transition-colors">
